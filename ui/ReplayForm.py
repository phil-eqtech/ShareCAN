...
class Ui_REPLAY(object):
    def setupUi(self, REPLAY):
        ...
        self.checkLive = QtWidgets.QCheckBox(self.replayMainGrid)
        self.checkLive.setText("")
        self.checkLive.setChecked(False)
        self.checkLive.setTristate(False)
        self.checkLive.setObjectName("checkLive")
        self.gridLayout_2.addWidget(self.checkLive, 3, 3, 1, 1)
