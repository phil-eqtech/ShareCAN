...
class Ui_REPLAY(object):
    ...
    def retranslateUi(self, REPLAY):
        ...
        self.comboFeedback.setItemText(1, _translate("REPLAY", "LIVE_REPLAY"))
        self.comboFeedback.setItemText(2, _translate("REPLAY", "RECORD_REPLAY"))
        self.comboFeedback.setItemText(3, _translate("REPLAY", "NEW_SESSION_RECORD"))
