...
mongo ShareCAN --eval 'db.devices.update({"name" : "Nano-can"},{ "name" : "Nano-can", "interfaces" : [ { "type" : "can", "label" : "CAN", "mode" : "slcan", "id" : "can0" } ], "ref" : "FTDI_FT232R_USB_UART_", "builtin" : false }, true)'
