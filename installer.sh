...
mongo ShareCAN --eval 'db.devices.update({"name" : "Pican Duo"},{"name" : "Pican Duo", "interfaces" : [ { "type" : "can", "mode" : "builtincan", "label" : "CAN A" }, { "type" : "can", "mode" : "builtincan", "label" : "CAN B" } ], "ref" : "SPI", "builtin" : true }, true)'
mongo ShareCAN --eval 'db.devices.update({"name" : "Pican"},{"name" : "Pican", "interfaces" : [ { "type" : "can", "mode" : "builtincan", "label" : "CAN" } ], "ref" : "SPI 2", "builtin" : true }, true)'
mongo ShareCAN --eval 'db.devices.update({"name" : "Peak"},{"name" : "Peak", "interfaces" : [ { "type" : "can", "mode" : "builtincan", "label" : "CAN" } ], "ref" : "SPI 2", "builtin" : true }, true)'
